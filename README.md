<div align="center">
  ...
  <h3 align="center">Threads Clone</h3>
   ...
   <div align="center">
     A Threadsweb application built with Next.js, Clerk, and MongoDB.
    </div>
</div>
...
```bash
git clone https://github.com/jatin-vashisht/Threads-Clone.git
cd threads
```
...
![Login Page](https://firebasestorage.googleapis.com/v0/b/disney-plus-hotstar-clon-13914.appspot.com/o/images%2FScreenshot%20(5).png?alt=media&token=0947512e-99b9-4f16-9bc9-04c258442611)
*Login Screen.*

![Screenshot 2](https://firebasestorage.googleapis.com/v0/b/disney-plus-hotstar-clon-13914.appspot.com/o/images%2FScreenshot%20(6).png?alt=media&token=1172b7a5-106d-4ce5-8835-50cb402b34f4)
*Home Page.*

## Contributing

We welcome contributions from the community! If you're interested in contributing to the development of the Threads Clone App, please follow these guidelines:
...
If you find any bugs or have suggestions for new features, please open an issue on the [Issues](https://github.com/jatin-vashisht/Threads-Clone.git/issues) page.

### Community Guidelines

Be respectful and inclusive when participating in discussions. We encourage open communication and collaboration.

Thank you for contributing to the Threads Clone App!
